    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 16) {
                ...
                // Dòng mô tả cần chừa khoảng cách dưới
...
//                    .padding(.bottom, 16)
                ...
                // Các nội dung phía dưới (ví dụ 3 mục) sẽ cách ra nhờ padding trên
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 16) {
                ...
                // Limit content width so boxes and button share the same width
                VStack(spacing: 12) {
                    // Box 1 - primary200 background, centered, vertical padding 12
                    HStack(spacing: 8) {
                        Text("⚖️")
                    ...
                    // Box 2 - primary200 background, centered, vertical padding 12
                    HStack(spacing: 8) {
                        Text("💊")
                    ...
                    // Box 3 - primary200 background, centered, vertical padding 12
                    HStack(spacing: 8) {
                        Text("💬")
                        Text("Quick check-in")
                    }
                    ...
                    .background(Color.primary200)
                    .cornerRadius(12)
                    .padding(.bottom, 24) // space before the button
...
struct OnboardingView_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            ...
            MomsHerePage(currentPage: .constant(1))
                .previewDisplayName("MomsHerePage")
            YouCanDoThisPage(currentPage: .constant(2))
                .previewDisplayName("YouCanDoThisPage")
            JustThreeThingsPage(currentPage: .constant(3))
                .previewDisplayName("JustThreeThingsPage")
            WhyThisWorksPage(currentPage: .constant(4))
                .environmentObject(AppState())
                .previewDisplayName("WhyThisWorksPage")
        }
    }
}
